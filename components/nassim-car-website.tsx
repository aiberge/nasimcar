...
export function NassimCarWebsite() {
  ...
  const [selectedFilters, setSelectedFilters] = useState({ type: '', location: '', ac: false })
  ...
  const filteredCars = cars.filter(car => {
    return (
      ...
      (selectedFilters.location === '' || car.location === selectedFilters.location) &&
    ...
    <div className="min-h-screen bg-black text-white">
      <nav className="absolute top-0 left-0 right-0 flex justify-between items-center p-4 z-50">
        <div className="flex items-center">
          <Image src={Logo} alt="Nassim Car Logo" width={120} height={120} className="mr-2" />
        </div>
          ...
          >
            <section className="relative h-screen">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center z-10">
                <h2 className="text-5xl font-bold mb-8 text-white">Bienvenue chez <span className="text-[#FC0F1D]">Nassim Car</span></h2>
                <button
        ...
        {currentPage === 'about' && (
          ...
          >
            <div className="max-w-4xl mx-auto">
              <h2 className="text-4xl font-bold mb-8 text-center">À Propos de Nassim Car</h2>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <p className="text-gray-300">
                    Chez Nassim Car, notre mission est de fournir une expérience de location de voiture exceptionnelle,
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-gray-300">
                    NR32, Rue Elouafae2, Oujda<br />
                      60000 Oujda, Maroc
                    </p>
                    <div className="mt-4 space-y-2">
                      <div className="flex items-center">
                        <Phone className="w-5 h-5 mr-2 text-red-600" />
                        <span>+212 6 72 96 13 03</span>
                      </div>
                      <div className="flex items-center">
                        <Mail className="w-5 h-5 mr-2 text-red-600" />
                        <span>contact@nassimcar.ma</span>
                      </div>
                    </div>
                  </div>
      ...
      <footer className="bg-gray-900 text-white py-8 px-4 md:px-8">
        <div className="max-w-6xl mx-auto flex flex-wrap justify-between items-center">
          <div className="w-full md:w-1/3 mb-6 md:mb-0 md:pr-8">
            <h3 className="text-2xl font-bold text-red-600 mb-2">Nassim Car</h3>
          ...
          <div className="w-full md:w-1/3">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-white hover:text-red-600 transition duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772A4.902 4.902 0 015.45 22c-.636-.247-1.363-.416-2.427-.465-1.067-.048-1.407-.06-4.123-.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772 4.902 4.902 0 011.772-1.153c.636-.247 1.363-.416 2.427-.465 1.064-.048 1.407-.06 4.123-.06h.08zM12 6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333 0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="#" className="text-white hover:text-red-600 transition duration-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="mt-8 text-center text-sm">
          <p>&copy; 2024 Nassim Car. Tous droits réservés.</p>
        </div>
      </footer>
      ...
      <Dialog open={showReservationConfirmation} onOpenChange={closeReservationConfirmation}>
        <DialogContent className="bg-gray-900 text-white">
          <DialogHeader>
            ...
            <DialogDescription>
              <p className="mt-4">Merci d'avoir choisi Nassim Car pour votre location de voiture.</p>
              ...
              <div className="mt-6 space-y-4">
                ...
                </div>c:\Users\LEGION 5 PRO\Downloads\image-removebg-preview.png
              </div>
            </DialogDescription>
          </DialogHeader>
        </DialogContent>
